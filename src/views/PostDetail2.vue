  ...
  <div>
          ...
          <el-row :gutter="20" style="min-height: 200px">
            ...
            <el-col :span="21">
              ...
              <div class="content-tail">
                <div @click="agree">
                  <svg class="agree-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="200"
                    height="200">
                    <path
                ...
                <template v-if="post.u_id === store.state.ownId">
                  <el-popconfirm confirm-button-text="确定" cancel-button-text="取消" title="确定删除此帖？" @confirm="deletePost">
                    <template #reference>
    ...
    <ul class="tool-sidebar">
      <li @click="toSendComment = true" title="评论">
        <svg class="tool-sidebar-icon" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="32"
          height="32">
          <path
